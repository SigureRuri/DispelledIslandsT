...
# TSBのデータパックで先にtitleが表示されているので、subtitleのみの表示でよい
title @a subtitle [{"text":"PROGRESS","color":"green","bold":true},{"text":"  ","color":"white"},{"score":{"name":"$DIT.DispelledIslandsCount","objective":"Global"},"color":"white","bold":true},{"text":"/","color":"gray","bold":false},{"score":{"name":"$DIT.NumberOfIslands","objective":"Global"},"color":"white","bold":true}]
